...
{
    public static final String START_ACTIVITY = "/MiWearController-Start_activity";
    public static final String STOP_ACTIVITY = "/MiWearController-Stop_activity";
    ...
    public static final String GYROSCOPE_VALUES = "gyroscopeValues";
