...
public class ButtonView extends View
{
    ...
    public ButtonName mPressedButton = ButtonName.None;
    public ButtonName getPressedButton(){return mPressedButton;}
    ...
    public void setCenterButtonEnabled(boolean enabled)
    {
        mCenterEnabled =enabled;
        this.invalidate();
    }
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        {
            _mainPaint.setStyle(Paint.Style.FILL);
            _mainPaint.setColor(mPressedButton == ButtonName.Center ? _centralButtonPressedColor:_centralButtonUnpressedColor);
    ...
    {
        if(_button!= mPressedButton)
        {
            if(mPressedButton != ButtonName.None)
                mButtonListener.onButtonHold(mPressedButton);

            mPressedButton = _button;

            if(mPressedButton != ButtonName.None)
                mButtonListener.onButtonPress(mPressedButton);
